...
function PricingTable() {
    return (
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6">Pricing Plans</h2>
            <p className="text-gray-600 dark:text-gray-400">Please upgrade to a premium subscription to access this feature.</p>
        </div>
    );
}
